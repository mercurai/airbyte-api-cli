...
class TestHealthCommand(unittest.TestCase):
    def setUp(self):
        Registry.reset()
        import importlib
        import airbyte_api_cli.plugins.health as _mod
    ...
    def test_health_calls_get_health(self):
        import argparse
        from airbyte_api_cli.plugins.health.commands import _handle
    ...
    def test_health_prints_output(self):
        ...
        with patch("airbyte_api_cli.plugins.health.commands.output") as mock_output:
            context, mock_client = self._make_context({"available": True})
    ...
    def test_plugin_registered(self):
        from airbyte_api_cli.plugins.health import register
        Registry.reset()
        register()
    ...
    def test_register_commands_adds_parser(self):
        import argparse
        from airbyte_api_cli.plugins.health.commands import register_commands
